...
class PageHeader extends Component {
    ...
    render() {
        const { screen_width, title, title_only, show_date_range, date_range, handleDateRangeChange, show_platform, platform, handlePlatformChange, show_granularity, granularity, handleGranularityChange, show_past_hours, handlePastHours, line_chart, pie_chart, paper_plane, group, repeat } = this.props;
